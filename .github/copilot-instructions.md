...
## Project Overview
- **exercAIse** is a JSON-first fitness and nutrition program generator, focused on structured, coach-style workout plans for a 40-year-old male with recurring joint issues.
...
- **Chat Modes**: Use `.github/chatmodes/kai.chatmode.md` to run in Kai mode (workouts/recovery). Content generation follows:
